...
export const CardFlipView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#FAFAFA] flex flex-col items-center justify-start pt-20 sm:pt-24 pb-16 px-2 sm:px-6 select-none">
      {/* Header section - Fully mobile responsive */}
      ...
      {/* Responsive Grid: 2 cards per row on mobile (grid-cols-2), 6 cards in 1 row on web/desktop (md:grid-cols-6 lg:grid-cols-6) */}
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* FLIPPED FACE (The specific Jin Yuyeon Photo) */}
      ...
      <div className="mt-8 text-[11px] text-[#71717A] text-center font-mono uppercase tracking-wider max-w-lg break-keep px-2">
        * 총 6장의 카드로 구성되어 있으며, 깃허브에서 <code className="text-[#c084fc]">"image"</code> 부분을 원하는 이미지 경로(예: <code className="text-[#c084fc]">"photo.jpg"</code>)로 자유롭게 수정하실 수 있습니다.
      </div>
    </div>
  );
};
